    ...
    controlNav: "thumbnails"
					...
					<div class="col-md-5 single-top-in simpleCart_shelfItem">
						...
						<h4>Bota Democrata Stroke</h4>
							...
							<p>A Bota Democrata Stroke traz uma tendência de moda que chegou há alguns anos mas ainda continua em alta. Confere á você liberdade na hora de combinar com grande estilo e personalidade. </p>
							<div class="available">
								<ul>
									<li>Color
										<select>
